...
{
    public class RATI_SBSMap : ClassMap<RATI_SBS>
    {
        public RATI_SBSMap()
        {
            ...
            Map(m => m.CapitalCertainty).Index(11);
            ...
            Map(m => m.MarketValueCurrencyDirtyPrice).Index(16);
            Map(m => m.AccountingClassification).Index(17);
            Map(m => m.TotalMarketValueCleanPrice).Index(18);
            Map(m => m.MarketValueCurrencyCleanPrice).Index(19);
